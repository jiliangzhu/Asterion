...
_JOB_SPECS = [
    ...
    ColdPathJobSpec(
        ...
        description="Run advisory-only Opportunity Triage Agent review over persisted weather opportunity, queue, and microstructure surfaces.",
        mode="scheduled",
        upstream_jobs=["weather_operator_surface_refresh"],
        input_tables=[
        ...
        handler_name="run_weather_opportunity_triage_review_job",
        default_schedule_key="weather_opportunity_triage_review_hourly",
    ),
    ColdPathJobSpec(
...
_SCHEDULE_SPECS = [
    ...
    ColdPathScheduleSpec(
        schedule_key="weather_opportunity_triage_review_hourly",
        job_name="weather_opportunity_triage_review",
        cron_schedule="59 * * * *",
        execution_timezone="UTC",
        enabled_by_default=True,
