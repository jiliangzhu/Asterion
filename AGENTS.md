...
- `P2` 已关闭
- `P3` 已关闭
- `P4` scaffold 已落地，但后续开发已进入 `post-P4 remediation`
...
- 完整产品化 operator UI
- calibration-driven forecast uncertainty
- execution-aware opportunity model / expected-PnL ranking
...
当前 post-P4 remediation 阶段，仍必须保持以下边界：
