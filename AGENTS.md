...
- official signer backend / KMS / HSM / live submitter
...
- 允许：real data ingress、capability refresh、external observation、signer shell、submitter dry-run / shadow、controlled live readiness
