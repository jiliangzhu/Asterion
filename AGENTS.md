...
10. `docs/10-implementation/checklists/P2_Closeout_Checklist.md`
11. `docs/10-implementation/runbooks/P1_Watch_Only_Replay_Cold_Path_Runbook.md`
12. `docs/10-implementation/runbooks/P2_Cold_Path_Orchestration_Job_Map_Runbook.md`
...
- real signer backend / KMS / HSM / live submitter
- 完整产品化 operator UI
...
当前进入 `P4` 后，允许推进的是 `live prerequisites`，但仍必须保持以下边界：

- 允许：real data ingress、capability refresh、external observation、signer shell、submitter dry-run / shadow、chain tx scaffold、controlled live readiness
