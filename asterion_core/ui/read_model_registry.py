...
_READ_MODEL_RECORDS: tuple[ReadModelCatalogRecord, ...] = (
    ...
    ReadModelCatalogRecord(
        table_name="ui.opportunity_triage_summary",
        schema_version=READ_MODEL_SCHEMA_VERSION,
        builder_name="ops_review_builder",
        primary_key_columns=("market_id",),
        primary_score_column=None,
        truth_source_description="latest opportunity triage overlay summary",
        required_columns=(
            "market_id",
            "latest_agent_invocation_id",
            "latest_agent_status",
    ...
    ReadModelCatalogRecord(
        table_name="ui.market_microstructure_summary",
        schema_version=READ_MODEL_SCHEMA_VERSION,
        builder_name="execution_builder",
        primary_key_columns=("summary_id",),
        primary_score_column="execution_intelligence_score",
        truth_source_description="deterministic execution-intelligence market summary",
        required_columns=(
            "summary_id",
            "market_id",
            "side",
    ...
    ReadModelCatalogRecord(
        table_name="ui.surface_delivery_summary",
        schema_version=READ_MODEL_SCHEMA_VERSION,
        builder_name="catalog_builder",
        primary_key_columns=("surface_id",),
        primary_score_column=None,
        truth_source_description="operator surface delivery summary",
        required_columns=(
            "surface_id",
            "primary_table",
            "delivery_status",
    ...
    ReadModelCatalogRecord(
        table_name="ui.system_runtime_summary",
        schema_version=READ_MODEL_SCHEMA_VERSION,
        builder_name="catalog_builder",
        primary_key_columns=("generated_at",),
        primary_score_column=None,
        truth_source_description="system runtime and delivery summary",
        required_columns=(
            "generated_at",
...
_SURFACE_SPECS: tuple[SurfaceTruthCheckSpec, ...] = (
    ...
    SurfaceTruthCheckSpec(
        surface_id="agents",
        table_names=("ui.agent_review_summary", "ui.proposal_resolution_summary", "ui.opportunity_triage_summary"),
    ),
)
