...
_READ_MODEL_RECORDS: tuple[ReadModelCatalogRecord, ...] = (
    ...
    ReadModelCatalogRecord(
        ...
        required_columns=("market_id", "ranking_score", "source_badge", "source_truth_status", "primary_score_label"),
    ),
    ReadModelCatalogRecord(
    ...
    ReadModelCatalogRecord(
        ...
        required_columns=("station_id", "source", "metric", "forecast_horizon_bucket"),
    ),
    ReadModelCatalogRecord(
...
_SURFACE_SPECS: tuple[SurfaceTruthCheckSpec, ...] = (
    ...
    SurfaceTruthCheckSpec(
        surface_id="agents",
        table_names=("ui.agent_review_summary",),
    ),
)
