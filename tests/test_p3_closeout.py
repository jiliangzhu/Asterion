...
class P3CloseoutDocsTest(unittest.TestCase):
    def test_p3_closeout_targets_exist(self) -> None:
        expected = [
            ROOT / "docs" / "10-implementation" / "versions" / "v1.0" / "checklists" / "P3_Closeout_Checklist.md",
            ROOT / "docs" / "10-implementation" / "versions" / "v1.0" / "runbooks" / "P3_Paper_Execution_Runbook.md",
            ROOT / "docs" / "10-implementation" / "versions" / "v1.0" / "phase-plans" / "P3_Implementation_Plan.md",
    ...
    def test_navigation_docs_reference_p3_closeout_materials(self) -> None:
        expected_refs = {
            ...
            ROOT / "docs" / "00-overview" / "versions" / "v2.0" / "DEVELOPMENT_ROADMAP.md": ["P3_Closeout_Checklist.md", "P3_Paper_Execution_Runbook.md"],
        }
