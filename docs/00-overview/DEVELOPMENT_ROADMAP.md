...
**版本**: v1.4
**更新日期**: 2026-03-16
**目标**: 将已冻结的设计文档转化为可执行开发顺序，既保留 Weather MVP 与 post-P4 remediation 的历史开发顺序，也为当前 `v2.0 planning` 提供单一导航入口。
...
- deep audit 后续工作已收口为 [Post_P4_Remediation_Implementation_Plan.md](../10-implementation/phase-plans/Post_P4_Remediation_Implementation_Plan.md) 中的 historical accepted remediation record
...
- 当前 active planning entry 是：
  - [V2_Implementation_Plan.md](../10-implementation/phase-plans/V2_Implementation_Plan.md)
...
- `P3` 的 canonical 实施文档见：
  - [P3_Implementation_Plan.md](../10-implementation/phase-plans/P3_Implementation_Plan.md)
...
这些阶段的详细交付物、持久化预期、测试与 exit criteria，保留以 [Post_P4_Remediation_Implementation_Plan.md](../10-implementation/phase-plans/Post_P4_Remediation_Implementation_Plan.md) 为 historical accepted remediation record；当前新阶段规划统一看 [V2_Implementation_Plan.md](../10-implementation/phase-plans/V2_Implementation_Plan.md)。
...
- [AlphaDesk_Migration_Ledger.md](../10-implementation/migration-ledger/AlphaDesk_Migration_Ledger.md) 中 `health_monitor_v1` / `ui_db_replica` 已迁入，或已完成 Asterion 原生替代
...
- 相关收口依据以 [P2_Closeout_Checklist.md](../10-implementation/checklists/P2_Closeout_Checklist.md) 和 [P3_Implementation_Plan.md](../10-implementation/phase-plans/P3_Implementation_Plan.md) 为准
