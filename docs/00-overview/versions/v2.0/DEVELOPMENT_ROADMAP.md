...
- 当前 `v2.0` 内部阶段状态：
  ...
  - 当前 current tranche: [P9_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P9_Implementation_Plan.md)
  - `Phase 9` 当前 in progress，且 `core implemented / closeout pending`
