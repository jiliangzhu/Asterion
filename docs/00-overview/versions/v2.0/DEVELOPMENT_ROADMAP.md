...
- historical post-P4 remediation 的 `Phase 5` 到 `Phase 9` 已全部 accepted；当前 `v2.0 Phase 9` 是独立 tranche，主题为 operator surface delivery / throughput scaling
...
- 最近 accepted tranche records 是：
  - [P11_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P11_Implementation_Plan.md)
  - [P10_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P10_Implementation_Plan.md)
...
- 当前 `v2.0` 内部阶段状态：
  ...
  - 最近 accepted tranche record:
    - [P11_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P11_Implementation_Plan.md)
  - 更早的 tranche-specific implementation record:
    - [P9_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P9_Implementation_Plan.md)
- 最近 accepted tranche closeout checklist 是：
  - [P11_Closeout_Checklist.md](../../../10-implementation/versions/v2.0/checklists/P11_Closeout_Checklist.md)
- 更早 accepted tranche closeout checklist 仍保留：
  - [P10_Closeout_Checklist.md](../../../10-implementation/versions/v2.0/checklists/P10_Closeout_Checklist.md)
...
-> Phase 0 -> Phase 11 accepted
-> no newer tranche-specific implementation plan currently open
```
...
这些阶段的详细交付物、持久化预期、测试与 exit criteria，保留以 [Post_P4_Remediation_Implementation_Plan.md](../../../10-implementation/versions/v1.0-remediation/phase-plans/Post_P4_Remediation_Implementation_Plan.md) 为 historical accepted remediation record；当前 `v2.0` umbrella 规划统一看 [V2_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/V2_Implementation_Plan.md)，[P11_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P11_Implementation_Plan.md) 保留为最近 accepted tranche record，[P11_Closeout_Checklist.md](../../../10-implementation/versions/v2.0/checklists/P11_Closeout_Checklist.md) 保留为最近 accepted tranche 的 closeout checklist；[P10_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P10_Implementation_Plan.md)、[P9_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P9_Implementation_Plan.md)、[P8_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P8_Implementation_Plan.md)、[P7_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P7_Implementation_Plan.md) 与 [P6_Implementation_Plan.md](../../../10-implementation/versions/v2.0/phase-plans/P6_Implementation_Plan.md) 保留为更早 tranche / accepted closeout / baseline records；当前还没有比 `Phase 11` 更新的 tranche-specific implementation plan 已打开。
...
最近 accepted `v2.0 Phase 11`：

- opportunity triage / execution intelligence agent
- advisory-only triage overlay
- replay / evaluation closure

### Milestone 8

更早 accepted `v2.0 Phase 10`：

- deterministic ROI repair
- execution-intelligence foundation
- allocator scheduling uplift

### Milestone 9

更早的 `v2.0 Phase 9` tranche record：

- delivery / scaling follow-on
- operator surface refresh / delivery contract baseline

### Milestone 10

最近 accepted `v2.0 Phase 11` closeout：
...
更早 accepted `v2.0 Phase 10` closeout：

- `PRAGMA` regression repair
- home queue `blocked_backlog`
- execution priors grain / fallback hardening
