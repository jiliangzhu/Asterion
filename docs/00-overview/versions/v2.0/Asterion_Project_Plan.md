...
**创建日期**: 2026-03-07
**更新日期**: 2026-03-21
**状态**: 详细设计完成，`P0` 到 `P4` 已 accepted，post-P4 remediation 已 accepted；`v2.0` 当前阶段状态为 `v2.0 implementation active`，最近 accepted tranche 为 `Phase 8`，当前未打开新的 tranche-specific implementation plan
...
✅ **数据模型设计** - 完整的数据库表设计
✅ **风险管理框架** - 仓位限制、熔断机制
✅ **开发路线图** - 历史 `P0` 到 `P4`、historical post-P4 remediation、当前 `v2.0 implementation active` umbrella 入口，以及最近 accepted `Phase 8`
...
- [P7 Closeout Checklist](../../../10-implementation/versions/v2.0/checklists/P7_Closeout_Checklist.md)
- [P6 accepted tranche baseline](../../../10-implementation/versions/v2.0/phase-plans/P6_Implementation_Plan.md)
- [Documentation Index](../../Documentation_Index.md)
- [开发路线图](./DEVELOPMENT_ROADMAP.md)
- [Implementation Index](../../../10-implementation/Implementation_Index.md)
- [Post-P4 Remediation 历史实施记录](../../../10-implementation/versions/v1.0-remediation/phase-plans/Post_P4_Remediation_Implementation_Plan.md)
- [P4 实施文档](../../../10-implementation/versions/v1.0/phase-plans/P4_Implementation_Plan.md)
- [P4 关闭清单](../../../10-implementation/versions/v1.0/checklists/P4_Closeout_Checklist.md)
- [P4 Controlled Rollout Decision Runbook](../../../10-implementation/versions/v1.0/runbooks/P4_Controlled_Rollout_Decision_Runbook.md)
- [P3 实施文档](../../../10-implementation/versions/v1.0/phase-plans/P3_Implementation_Plan.md)
- [P2 实施文档](../../../10-implementation/versions/v1.0/phase-plans/P2_Implementation_Plan.md)
- [P1 实施文档](../../../10-implementation/versions/v1.0/phase-plans/P1_Implementation_Plan.md)
- [P0 实施文档](../../../10-implementation/versions/v1.0/phase-plans/P0_Implementation_Plan.md)
- [P1 关闭清单](../../../10-implementation/versions/v1.0/checklists/P1_Closeout_Checklist.md)
- [P1 运行交接 Runbook](../../../10-implementation/versions/v1.0/runbooks/P1_Watch_Only_Replay_Cold_Path_Runbook.md)
...
Asterion/
  ...
  agents/                         # AI Agent（当前 active 只保留 resolution）
    common/
      client.py
      persistence.py
      runtime.py
...
#### 5.2.2 Deterministic Rule/Spec Validation（规则解析校验）

**职责**:
- 校验 deterministic `Rule2SpecDraft -> WeatherMarketSpecRecord`
- 只输出 station-first 的校验结论、风险标记和 human review hook
- 不替代 deterministic parser，不直接写 `weather.weather_market_specs`
- 当前不再把这一步实现为独立 LLM agent
...
- `station_id` 是必需语义
- 不允许回流 `city-first`
- validation output 只能作用于已冻结的 station-first 字段
...
- `P1` 关闭依据见 [P1_Closeout_Checklist.md](../../../10-implementation/versions/v1.0/checklists/P1_Closeout_Checklist.md)
- 当前 canonical 运行入口见 [P1_Watch_Only_Replay_Cold_Path_Runbook.md](../../../10-implementation/versions/v1.0/runbooks/P1_Watch_Only_Replay_Cold_Path_Runbook.md)
...
- historical rollout decision boundary artifacts；当前 active implementation entry 已切换到 `v2.0`
...
1. [ ] 实现 Gamma API 客户端
2. [ ] 实现 Market Scout
3. [ ] 实现 deterministic rule/spec validation（第一版）
4. [ ] 建立数据库 schema
