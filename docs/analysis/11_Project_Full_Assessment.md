...
- `docs/00-overview/versions/v2.0/Asterion_Project_Plan.md` 也写 `P3 已关闭, P4 已关闭`。
- `docs/10-implementation/versions/v1.0/phase-plans/P4_Implementation_Plan.md` 标记状态为 `closed`。

#### 与之冲突的文档事实

- `docs/10-implementation/versions/v1.0/checklists/P3_Closeout_Checklist.md` 顶部写的是 `状态: closeout in progress`，且核查项未完成。
- `docs/10-implementation/versions/v1.0/checklists/P4_Closeout_Checklist.md` 顶部写的是 `状态: closeout ready`，不是 closed，而且核查项也未打勾。
...
- `docs/10-implementation/versions/v1.0/phase-plans/P4_Implementation_Plan.md`
- `docs/10-implementation/versions/v1.0/checklists/P3_Closeout_Checklist.md`
- `docs/10-implementation/versions/v1.0/checklists/P4_Closeout_Checklist.md`
- `ui/app.py`
...
- `docs/00-overview/versions/v2.0/Asterion_Project_Plan.md`：写 `P3/P4 已关闭`
- `docs/10-implementation/versions/v1.0/phase-plans/P4_Implementation_Plan.md`：写 `closed`
- 但：
  - `docs/10-implementation/versions/v1.0/checklists/P3_Closeout_Checklist.md`：`closeout in progress`
  - `docs/10-implementation/versions/v1.0/checklists/P4_Closeout_Checklist.md`：`closeout ready`
  - 且 checklist 未完成
...
- `docs/10-implementation/versions/v1.0/phase-plans/P3_Implementation_Plan.md`
- `docs/10-implementation/versions/v1.0/phase-plans/P4_Implementation_Plan.md`
- `docs/10-implementation/versions/v1.0/checklists/P3_Closeout_Checklist.md`
- `docs/10-implementation/versions/v1.0/checklists/P4_Closeout_Checklist.md`
- `docs/10-implementation/versions/v1.0/runbooks/P3_Paper_Execution_Runbook.md`
- `docs/10-implementation/versions/v1.0/runbooks/P4_Controlled_Live_Smoke_Runbook.md`
- `docs/10-implementation/versions/v1.0/runbooks/P4_Controlled_Rollout_Decision_Runbook.md`
- `docs/10-implementation/versions/v1.0/runbooks/P4_Real_Weather_Chain_Smoke_Runbook.md`
