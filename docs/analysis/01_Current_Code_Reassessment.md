...
- runbook 把 `ASTERION_CONTROLLED_LIVE_SECRET_ARMED=true` 写成 controlled-live smoke 的前置条件（`docs/10-implementation/versions/v1.0/runbooks/P4_Controlled_Live_Smoke_Runbook.md:57-67`）。
